<?php
    ...
    $sql = "Select * from Driver_Informations";
            ...
            <div class="col">
                <div class="card" style="margin-top: 10%;">
                    <div class="card-header">
                        <h2 class="display-6 text-center"><b>Driver Informations</b></h2>
                    </div>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                ...
                                ?>  
                                    ...
                                    <td> <?php echo $row['Driver_NID_Info']; ?></td>      
                                    <td> <?php echo $row['Driver_Contact_Number']; ?></td>      
                                    <td> <a href="view_btn_function_Drivers.php?driver_id=<?php echo $row['Driver_ID']; ?>" class="btn btn-primary">View</a></td>
