<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $conn->prepare("SELECT Driver_ID, Driver_Name, Driver_Password FROM Driver_Informations WHERE Driver_Email = ?");
...
<body style="background-color: black; padding: 0%; margin: 0%;">
    ...
    <div class="container" style="text-align: center">
        <h1 style="color: #fb8500;" class="heading-for-login">Driver Login</h1><br>
